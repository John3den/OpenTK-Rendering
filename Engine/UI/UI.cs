...
namespace Engine
{
    ...
    public class UI
    {
        public string[] LightingModes = { "point", "spot", "direct" };
        ...
        public void Render(GameWindow window, Timer timer, float globalTime, ref int n, int N, ref int lightMode, ref int sceneNumber)
        {
