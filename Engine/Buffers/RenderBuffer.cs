...
namespace Engine
{
    public class RenderBuffer
    {
        ...
        {
            _state++;
            _actor.Transform = Matrix4.CreateTranslation(new Vector3(0.1f * (MathF.Floor(_state / 10)) * MathF.Sin((float)_state / 10), 0, 0.1f * (MathF.Floor(_state / 10)) * MathF.Cos((float)_state / 10)));
        }
